        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/">
                <a className="text-[#4CAF50] text-2xl font-montserrat font-bold flex items-center">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <Link href="/predict">
              <a className="bg-[#4CAF50] hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md transition">
                Get Started
              </a>
            </Link>
          </div>
      ...
      <div className={`sm:hidden ${mobileMenuOpen ? "block" : "hidden"}`} id="mobile-menu">
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          <div className="flex items-center px-4">
            <Link href="/predict">
              <a className="w-full bg-[#4CAF50] hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md transition">
                Get Started
              </a>
            </Link>
          </div>
